...
class ChapterScraper:
    ...
    def get_newest_chapters(self):
        ...
        new_chapter_count = self.update_chapter_count(file_name, len(chapters))
        ...
        if new_chapter_count > 0:
            for ch in chapters[-new_chapter_count:]:
                ...
                new_chapters_wc[ch.get_text()] = self.find_word_count(ch_link)
